...
export const translations: Record<Locale, Translation> = {
  ko: {
    ...
    trips: {
      ...
      description:
        "봄, 가을, 겨울에 10인승 보트를 타고 바다 출조를 가요. 처음 오시는 분도 괜찮아요. 출조 포인트로 이동하여, 어디서 어떻게 낚시를 하는지 쉽게 알려드려요.",
  ...
  en: {
    ...
    hero: {
      eyebrow: "SINCE 2004 · NONSAN",
      title: ["Get your fishing gear", "at Nonsan Daemul Fishing."],
      description:
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          description: "We inspect and repair damaged fishing rods. We do not repair reels.",
    ...
    trips: {
      ...
      description:
        "In spring, autumn, and winter, we head out to sea on a 10-passenger boat. First-timers are welcome. Once we reach the fishing spot, we explain where and how to fish in simple terms.",
  ...
  zh: {
    ...
    about: {
      ...
      stats: ["开店年份", "20多年实战经验", "人座出钓船", "一对一装备建议"],
    ...
    services: {
      ...
      items: [
        ...
        { title: "也可以维修钓竿", description: "我们会检查并维修损坏的钓竿，但暂不维修渔轮。", tags: ["钓竿维修", "装备检查", "电话咨询"] },
    ...
    trips: {
      ...
      description: "春、秋、冬三季，我们会乘坐10人座钓鱼船出海。第一次参加也不用担心。到达出钓钓点后，我们会简单说明在哪里、怎样钓鱼。",
  ...
  ja: {
    ...
    about: {
      ...
      stats: ["創業年", "20年以上の現場経験", "人乗り釣行ボート", "一人ひとりに合う道具相談"],
    ...
    services: {
      ...
      items: [
        ...
        { title: "釣り竿も修理します", description: "壊れた釣り竿を確認して修理します。リールの修理は行っていません。", tags: ["ロッド修理", "用品点検", "電話相談"] },
    ...
    trips: {
      ...
      description: "春・秋・冬は、10人乗りボートで海へ釣行します。初めての方も大丈夫です。ポイントまで移動したら、どこでどのように釣るのかを分かりやすくご案内します。",
  ...
  vi: {
    ...
    hero: {
      ...
      title: ["Chuẩn bị đồ câu,", "hãy đến Daemul Nonsan."],
    ...
    about: {
      ...
      stats: ["Năm cửa hàng mở cửa", "Hơn 20 năm kinh nghiệm", "Thuyền câu chở khách", "Tư vấn theo nhu cầu"],
    ...
    services: {
      ...
      items: [
        ...
        { title: "Chúng tôi cũng sửa cần câu", description: "Chúng tôi kiểm tra và sửa những chiếc cần bị hỏng. Hiện chưa nhận sửa máy câu.", tags: ["Sửa cần", "Kiểm tra đồ", "Gọi tư vấn"] },
    ...
    trips: {
      ...
      description: "Vào mùa xuân, thu và đông, chúng tôi đi câu biển bằng thuyền 10 chỗ. Người mới đến lần đầu cũng không sao. Khi tới điểm câu, chúng tôi sẽ giải thích dễ hiểu nên câu ở đâu và câu như thế nào.",
  ...
  uz: {
    ...
    hero: {
      ...
      title: ["Baliq ovlash jihozlari uchun", "Nonsan Daemulga keling."],
    ...
    about: {
      ...
      stats: ["Do‘kon ochilgan yil", "20 yildan ortiq tajriba", "Yo‘lovchi baliq ovlash qayig‘i", "Shaxsiy maslahat"],
    ...
    services: {
      ...
      items: [
        ...
        { title: "Qarmoq tayoqchasini ham ta’mirlaymiz", description: "Singan qarmoq tayoqchasini tekshirib, ta’mirlaymiz. G‘altaklarni ta’mirlamaymiz.", tags: ["Tayoqcha ta’miri", "Jihoz tekshiruvi", "Telefon maslahati"] },
    ...
    trips: {
      ...
      description: "Bahor, kuz va qishda 10 kishilik qayiqda dengiz safariga chiqamiz. Birinchi marta kelganlar ham bemalol qatnashishi mumkin. Baliq ovlash joyiga yetgach, qayerda va qanday ovlashni sodda qilib tushuntiramiz.",
  ...
  ru: {
    ...
    hero: {
      ...
      title: ["За рыболовными снастями —", "в Nonsan Daemul."],
    ...
    about: {
      ...
      stats: ["Год открытия", "Более 20 лет опыта", "Пассажирская рыболовная лодка", "Личная консультация"],
    ...
    services: {
      ...
      items: [
        ...
        { title: "Ремонтируем и удилища", description: "Проверяем и ремонтируем сломанные удилища. Катушки не ремонтируем.", tags: ["Ремонт удилищ", "Проверка снастей", "Звонок заранее"] },
    ...
    trips: {
      ...
      description: "Весной, осенью и зимой мы выходим в море на 10-местной лодке. Новичкам тоже рады. Добравшись до точки, мы просто объясним, где и как ловить рыбу.",
    ...
    email: {
      ...
      cta: "Отправить в почтовом приложении",
  ...
  km: {
    ...
    hero: {
      ...
      title: ["ត្រូវការសម្ភារៈនេសាទ", "សូមមក Nonsan Daemul។"],
    ...
    about: {
      ...
      stats: ["ឆ្នាំបើកហាង", "បទពិសោធន៍ជាង 20 ឆ្នាំ", "ទូកនេសាទសម្រាប់អ្នកដំណើរ", "ការណែនាំផ្ទាល់ខ្លួន"],
    ...
    services: {
      ...
      items: [
        ...
        { title: "យើងក៏ជួសជុលដងសន្ទូច", description: "យើងពិនិត្យ និងជួសជុលដងសន្ទូចដែលខូច។ មិនមានសេវាជួសជុលរ៉ឺលទេ។", tags: ["ជួសជុលដង", "ពិនិត្យសម្ភារៈ", "សួរតាមទូរស័ព្ទ"] },
    ...
    trips: {
      ...
      description: "នៅរដូវផ្ការីក ស្លឹកឈើជ្រុះ និងរងា យើងជិះទូក 10 កៅអីទៅនេសាទសមុទ្រ។ អ្នកមកជាលើកដំបូងក៏មិនអីទេ។ ពេលទៅដល់កន្លែងនេសាទ យើងនឹងពន្យល់ឲ្យងាយយល់ថាត្រូវនេសាទនៅឯណា និងដោយរបៀបណា។",
  ...
  my: {
    ...
    hero: {
      ...
      title: ["ငါးမျှားပစ္စည်းပြင်ဆင်ဖို့ဆို", "Nonsan Daemul ကိုလာပါ။"],
    ...
    about: {
      ...
      stats: ["ဆိုင်ဖွင့်သည့်နှစ်", "နှစ် 20 ကျော်အတွေ့အကြုံ", "ခရီးသည်တင် ငါးမျှားလှေ", "တစ်ဦးချင်းပစ္စည်းအကြံပေး"],
    ...
    services: {
      ...
      items: [
        ...
        { title: "ငါးမျှားတံကိုလည်း ပြုပြင်ပေးပါတယ်", description: "ပျက်နေတဲ့ ငါးမျှားတံကို စစ်ဆေးပြီး ပြုပြင်ပေးပါတယ်။ Reel ကိုတော့ မပြုပြင်ပါ။", tags: ["တံပြုပြင်", "ပစ္စည်းစစ်ဆေး", "ဖုန်းဖြင့်မေးရန်"] },
    ...
    trips: {
      ...
      description: "နွေဦး၊ ဆောင်းဦးနဲ့ ဆောင်းရာသီမှာ လူ 10 စီးလှေနဲ့ ပင်လယ်ငါးမျှားခရီး ထွက်ပါတယ်။ ပထမဆုံးလာသူလည်း ရပါတယ်။ ငါးမျှားနေရာရောက်ရင် ဘယ်မှာ ဘယ်လိုငါးမျှားရမလဲဆိုတာ နားလည်လွယ်အောင် ရှင်းပြပေးပါတယ်။",
