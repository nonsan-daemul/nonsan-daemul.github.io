...
export const localeOptions: Array<{ code: Locale; label: string; shortLabel: string }> = [
  ...
  { code: "km", label: "ភាសាខ្មែរ", shortLabel: "ខ្មែរ" },
  { code: "my", label: "မြန်မာ", shortLabel: "မြန်မာ" },
];
...
export const translations: Record<Locale, Translation> = {
  ko: {
    ...
    homeLabel: "대물낚시 홈",
    navLabel: "주요 메뉴",
    nav: { about: "매장 소개", trips: "함께 떠나요", location: "오시는 길" },
    call: "전화하기",
    hero: {
      eyebrow: "SINCE 2004 · NONSAN",
      title: ["좋은 낚시는", "준비부터 다릅니다."],
      description:
        "논산에서 가장 큰 낚시용품점, 대물낚시입니다. 민물부터 바다까지 필요한 장비를 편하게 둘러보고, 궁금한 건 무엇이든 물어보세요.",
    ...
    about: {
      eyebrow: "대물낚시 이야기",
      title: ["저희도 낚시가 좋아서,", "현장을 잘 압니다."],
      description:
        "2004년부터 논산에서 낚시하시는 분들과 함께해 왔습니다. 물건만 판매하는 곳이 아니라, 저희도 직접 바다에 나가고 계절마다 달라지는 포인트와 채비를 살피며 꼭 필요한 준비를 도와드립니다.",
      stats: ["대물낚시 문을 연 해", "20년 넘게 쌓은 경험", "10인승 출조 보트", "내게 맞는 장비 상담"],
      storeAlt: "넓은 주차 공간을 갖춘 논산 대물낚시 매장 외관",
      caption: "천천히 둘러보고, 편하게 물어보세요.",
      parking: "매장 앞 넓은 주차 공간",
    },
    services: {
      eyebrow: "매장과 서비스",
      title: ["낚시 준비도, 수리도", "한곳에서 해결하세요."],
      description: "어떤 장비가 맞을지 모르겠다면 걱정하지 마세요. 낚시 방식과 대상어에 맞춰 차근차근 알려드립니다.",
      items: [
        {
          title: "낚시용품 한곳에",
          description: "민물·바다·루어·선상낚시까지, 필요한 낚싯대와 채비, 소품을 폭넓게 준비해 두었습니다.",
          tags: ["민물낚시", "바다낚시", "루어낚시"],
        },
        {
          title: "낚싯대 수리",
          description: "오랫동안 쌓아 온 경험으로 낚싯대와 낚시용품을 꼼꼼히 살펴보고 수리해 드립니다. 릴 수리는 하지 않습니다.",
          tags: ["낚싯대 수리", "용품 점검", "전화 문의"],
        },
        {
          title: "경험에서 나온 상담",
          description: "저희가 직접 출조하며 얻은 경험을 바탕으로 계절과 포인트, 대상어에 잘 맞는 장비와 채비를 추천해 드립니다.",
    ...
    trips: {
      eyebrow: "바다낚시 출조",
      title: ["바다 가기 좋은 날,", "같이 떠나요."],
      description:
        "봄·가을·겨울, 물때와 날씨가 맞으면 10인승 보트를 끌고 바다로 나갑니다. 처음 오신 분도 편하게 즐기실 수 있도록 포인트부터 채비까지 꼼꼼하게 안내해 드립니다.",
      boatAlt: "대물낚시 매장 앞 10인승 바다 출조 보트",
      boatLabel: "인승 보트 · 수시 출조",
      species: ["감성돔", "갈치", "쭈꾸미", "갑오징어", "문어", "우럭"],
      seasonLabel: "출조 시기",
      seasonValue: "봄 · 가을 · 겨울",
      guideLabel: "안내",
      guideValue: "처음부터 차근차근",
      bookingLabel: "예약",
      bookingValue: "전화로 미리 문의",
      inquiry: "출조 문의 041-736-4100",
      news: "최근 출조 소식",
    },
    marquee: "낚시용품 · 낚싯대 수리 · 바다 출조 · 채비 상담 · 논산 대물낚시",
    social: {
      eyebrow: "소식과 온라인 구매",
      title: "온라인에서도 편하게 만나요.",
      description: "출조 소식도 확인하고, 필요한 낚시용품도 온라인에서 편하게 만나보세요.",
    ...
    location: {
      ...
      storeName: "논산 대물낚시",
      description: "논산 시내에서 오기 편하고, 매장 앞 주차 공간도 넉넉합니다.",
      mapCta: "네이버 지도에서 길찾기",
      blogCta: "네이버 블로그 보기",
    },
  ...
  en: {
    ...
    trips: {
      ...
      inquiry: "Trip enquiries 041-736-4100",
  ...
  ja: {
    ...
    trips: {
      ...
      inquiry: "釣行のお問い合わせ 041-736-4100",
      news: "最近の釣行情報",
    },
  ...
  vi: {
    ...
    trips: {
      ...
      inquiry: "Hỏi chuyến câu 041-736-4100",
  ...
  uz: {
    ...
    trips: {
      ...
      inquiry: "Safar uchun 041-736-4100",
  ...
  ru: {
    ...
    trips: {
      ...
      inquiry: "Запись на выезд 041-736-4100",
  ...
  km: {
    ...
    trips: {
      ...
      inquiry: "សួរអំពីដំណើរ 041-736-4100",
  ...
  my: {
    ...
    trips: {
      ...
      inquiry: "ခရီးမေးမြန်းရန် 041-736-4100",
